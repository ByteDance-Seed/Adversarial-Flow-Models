...
def clip_grad_norm_(module: torch.nn.Module, grad_norm: float) -> float:
    if hasattr(module, "clip_grad_norm_"): # FSDP
        return module.clip_grad_norm_(grad_norm)
    else:
        return torch.nn.utils.clip_grad_norm_(module.parameters(), grad_norm)
